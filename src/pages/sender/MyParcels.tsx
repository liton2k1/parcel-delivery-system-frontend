...
import CreateParcel from "@/components/sender/CreateParcel";
import DeleteConfirmation from "@/components/sender/DeleteConformation";
  ...
  const content = (
    <div className="flex flex-wrap items-center justify-between gap-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <CreateParcel open={open} onOpenChange={setOpen} />
      </div>
    </div>
  );
