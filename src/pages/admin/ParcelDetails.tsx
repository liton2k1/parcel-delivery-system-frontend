import ParcelTimeLine from "@/components/admin/ParcelTimeLine";
...
import { IUpdatedBy } from "@/types/parcel";
    ...
    <section className="py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {!cancelledAt && (
                <div>
                  ...
                  <p className="font-semibold">
                    {estimatedDelivery
                      ? format(new Date(estimatedDelivery), "PP")
                      : "N/A"}
                  </p>
                </div>
              )}
        ...
        {statusLog && statusLog.length > 0 && (
          <ParcelTimeLine statusLog={statusLog} />
        )}
      </div>
    </section>
  );
